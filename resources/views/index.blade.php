...
@section('content')
    ...
    <div class="home-box">
        ...
        <p class="links" style="text-align: center;">
            <font aria-hidden="true" ><a href="{{ route('post.index') }}" aria-label="Blog!">
                    Enter Blog Section!</a></font>

            @if(isset($github_username) && $github_username)
                <font aria-hidden="true">/</font><a href="{{ route('projects') }}" aria-label="点击查看项目列表">Log In With!</a>
            @endif
